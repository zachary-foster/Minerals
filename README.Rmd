...
## Minerals_SK: A rimworld mod for the [Hardcore SK project](https://github.com/skyarkhangel/Hardcore-SK)
...
Mods designed to work with Minerals
...
Mods that work, but dont use the type of rocks that Minerals use and might not have balanced gameplay.

* Any mod that adds rock types
